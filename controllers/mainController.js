...
exports.updateOne = function (Model) {
  return asyncHandler(async function (req, res) {
    ...
    if (!record) {
      return res.status(400).json({ message: `${record} update failed!` });
    }
...
exports.deleteOne = function (Model) {
  return asyncHandler(async function (req, res) {
    ...
    if (!record) {
      return res.status(400).json({ message: `${record} deleteion failed!` });
    }
    return res.status(200).json({ status: "success", record: null });
  });
};
